...
from bias_detection.pipelines.political_mentions import create_pipeline as create_political_mentions_pipeline
...
def register_pipelines() -> dict[str, Pipeline]:
    ...
    pipelines["political_mentions"] = create_political_mentions_pipeline()
